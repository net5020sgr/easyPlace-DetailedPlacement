...
./ePlace -aux ./after_buffered/aes_cipher_top/aes_cipher_top_buf.aux   -noQP -internalLegal  -internalDP  -TDP -bb -outputPath ./eplace_solution
# ./ePlace -aux ./after_buffered/aes/aes_buf.aux  -fullPlot  -noQP -internalLegal  -internalDP  -TDP -bb -outputPath ./eplace_solution
...
# ./ePlace -aux ./after_buffered/des/des_buf.aux  -fullPlot  -targetOverflow 0.2  -noQP -internalLegal  -internalDP  -TDP -bb -outputPath ./eplace_solution
# ./ePlace -aux ./after_buffered/ac97_top/ac97_top_buf.aux  -fullPlot -targetDensity 0.9  -targetOverflow 0.2  -noQP -internalLegal  -internalDP  -TDP -bb -outputPath ./eplace_solution
# ./ePlace -aux ./after_buffered/pci_bridge32/pci_bridge32_buf.aux  -fullPlot -targetDensity 0.9  -targetOverflow 0.2  -noQP -internalLegal  -internalDP  -TDP -bb -outputPath ./eplace_solution
